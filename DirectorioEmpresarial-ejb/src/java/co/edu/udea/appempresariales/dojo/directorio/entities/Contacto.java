 ...
 */
package co.edu.udea.appempresariales.dojo.directorio.entities;
 ...
 */
@Entity
@Table(name = "contacto", catalog = "directoriobd", schema = "")
@XmlRootElement
@NamedQueries({
...
public class Contacto implements Serializable {
    ...
    public Contacto(Integer id, String nombre, String apellido, String telefono) {
        this.id = id;
        this.nombre = nombre;
    ...
    public String toString() {
        return "co.edu.udea.appempresariales.dojo.directorio.entities.Contacto[ id=" + id + " ]";
    }
